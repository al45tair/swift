...
EXPECTED_OPTIONS = [
    ...
    EnableOption('--install-swift-backtrace', dest='install_swift_backtrace'),
    ...
    EnableOption('--swift-backtrace', dest='build_swift_backtrace'),
    ...
    DisableOption('--skip-test-swift-backtrace',
                  dest='test_swift_backtrace'),
